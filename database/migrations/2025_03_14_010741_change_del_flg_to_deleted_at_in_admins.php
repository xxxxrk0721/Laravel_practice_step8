...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn('admins', 'del_flg')) {
            DB::statement("UPDATE admins SET deleted_at = NOW() WHERE del_flg = 1");
        }
    ...
    public function down(): void
    {
        ...
        DB::statement("UPDATE admins SET del_flg = 1 WHERE deleted_at IS NOT NULL");
